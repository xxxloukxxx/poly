...
\begin{ex}
	...
	\begin{center}
		...
		\begin{tabular}{c|c|c}
			\textbf{Sommes (ou différences)}            & \textbf{Produits de facteurs} & \textbf{Quotients (num./dén.)} \\
			\hline
			\rule[-5mm]{0mm}{12mm}$x - 3$               & $(6x + 1) \times (x - 1)$     & $\dfrac{x+3}{2}$               \\
			\rule[-5mm]{0mm}{12mm}$(2x + 4) + 3x$       & $2 \times (1 + 6x)$           & $\dfrac{5}{x-1}$               \\
			\rule[-5mm]{0mm}{12mm}$(5 - x) - (9 + 9x)$  & $(8 - x) \times (2 + x)$      & $\dfrac{3x^2+1}{2x-4}$         \\
			\rule[-5mm]{0mm}{12mm}$3 + (2 + 3x)(x - 2)$ & $(3 + 8x) \times (x - 8)^2$   & $\dfrac{(x+1)(x-3)}{x^2+5}$    \\
		\end{tabular}
	\end{center}
\end{ex}
		...
		\[
			\begin{array}{ll}%
				...
				\begin{array}{rcl}%
					D & =                                                                             & 25 + 16x^2 - 40x \\
					  & =                                                                             & 25 - 40x + 16x^2 \\
					  & \multicolumn{2}{l}{\quad\Rarr a=5,\ b=4x \quad\text{ (2}^\text{e}\text{ IR)}}                    \\
					  & =                                                                             & (5 - 4x)^2       \\
				\end{array}%
				\quad & \quad
				\def\arraystretch{1.5}%
				\begin{array}{rcl}%
					E & =                                                                             & 1 - 49x^2        \\
					  & =                                                                             & 1^2 - (7x)^2     \\
					  & \multicolumn{2}{l}{\quad\Rarr a=1,\ b=7x \quad\text{ (3}^\text{e}\text{ IR)}}                    \\
					  & =                                                                             & (1 - 7x)(1 + 7x) \\
				\end{array}%
			\end{array}%
		\]
