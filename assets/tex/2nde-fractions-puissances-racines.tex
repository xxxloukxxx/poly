...
\begin{piege}
	Ne pas confondre :
	$$(-3)^4 = (-3)\times(-3)\times(-3)\times(-3) = 81 \qquad \text{et} \qquad -3^4 = -(3\times3\times3\times3) = -81$$
\end{piege}
...
\begin{exo}[Puissances de $10$ et notation scientifique]
	...
	$$
		A = 4 \times 7 \times 10^{-5} \times 10^{-8}
		\qquad
		B = \frac{7 \times 10^{-4} \times 5 \times 10^8}{56 \times 10^{-9}}
		\qquad
		C = \frac{32 \times 10^{-4} + 6 \times 10^{-3}}{2 \times 10^{-5}}
	$$
...
\begin{ex}[Racines carrées]
	$3^2 = 9$ donc $\sqrt{9} = 3$ \qquad
	$2{,}6^2 = 6{,}76$ donc $\sqrt{6{,}76} = 2{,}6$ \qquad
...
\begin{demo}[$\sqrt{a} + \sqrt{b} > \sqrt{a+b}$]
	On a : $\left(\sqrt{a} + \sqrt{b}\right)^2 = \left(\sqrt{a}\right)^2 + 2\sqrt{a}\sqrt{b} + \left(\sqrt{b}\right)^2 = a + b + 2\sqrt{ab}$
...
\begin{methode}[Réduire des expressions avec racines carrées]
	...
	$$
		D = \sqrt{12} + 7\sqrt{3} - \sqrt{27}
		\qquad
		E = \sqrt{125} - 2\sqrt{20} + 6\sqrt{80}
	$$
...
\begin{methode}[Développer et réduire avec des racines carrées]
	...
	$$
		A = \left(\sqrt{3} - 4\right)^2
		\qquad
		B = \left(3 + \sqrt{5}\right)^2
		\qquad
		C = \left(\sqrt{2} - \sqrt{5}\right)\left(\sqrt{2} + \sqrt{5}\right)
		\qquad
		D = \left(3 + \sqrt{3}\right)\left(1 - \sqrt{2}\right)
	$$
