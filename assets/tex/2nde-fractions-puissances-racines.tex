...
\begin{prop}[Opérations sur les fractions]
  \[
    \frac{a}{D} + \frac{b}{D}
    = \frac{a + b}{D} \hspace{1.5cm} \frac{a}{D} - \frac{b}{D}
    = \frac{a - b}{D} \hspace{1.5cm} \frac{a}{b} \times \frac{c}{d}
    = \frac{a \times c}{b \times d} \hspace{1.5cm} \frac{a}{b} \div \frac{c}{d}
...
\begin{exo}[Effectuer des calculs de fractions]
  Calculer :
  \[
    A = \frac{5}{4} + \frac{6}{16} \hspace{1.5cm} B
      = \frac{5}{3} - \frac{6}{5} \hspace{1.5cm} C
      = \frac{2}{-3} \times \frac{-5}{11} \hspace{1.5cm} D
      = \frac{3}{4} \div \frac{-5}{8} \hspace{1.5cm} E
      = \frac{8}{7} - \frac{4}{7} \times \frac{5}{3}
  \]
    ...
    \[
      \begin{array}{c|c}
        \def\arraystretch{2} \begin{array}{rcl}
                             ...
                             \end{array}\qquad & \qquad \def\arraystretch{2} \begin{array}{rcl}
                                                                               B & = & 3 + \dfrac{5x}{2x+1}                     \\
...
\begin{exo}[Exprimer sous la forme d'une seule puissance]
  ...
  \[
    A = \frac{1}{4^2} \hspace{15mm} B
      = 4^5 \times 4^7 \hspace{15mm} C
      = \frac{5^4}{5^6} \hspace{15mm} D
      = 7^3 \times \left( 7^2 \right)^6 \hspace{15mm} E
      = 6^7 \times 9^7
  \]
...
\begin{exo}[Puissances de $10$ et notation scientifique]
  ...
  \[
    A = 10^4 \times 10^7 \qquad B
      = \frac{10^{-4}}{10^5} \qquad C
      = \left( 10^2 \right)^{-6} \qquad D
      = 10^{-4} \times \left( 10^3 \right)^{-1}
  \]

  \textbf{b)} Écrire en notation scientifique :
  \[
    A = 4 \times 7 \times 10^{-5} \times 10^{-8} \qquad B
      = \frac{7 \times 10^{-4} \times 5 \times 10^8}{56 \times 10^{-9}} \qquad C
      ...
      \begin{array}{r|r|r}
        \def\arraystretch{1.5} \begin{array}{rcl}
                                 A & = & 28 \times 10^{-13}    \\
                                   ...
                                   &   &                       \\
                                   &   &                       \\
                               \end{array} & \def\arraystretch{1.5} \begin{array}{rcl}
...
\begin{demo}[$\sqrt{a} + \sqrt{b} > \sqrt{a + b}$]
  On a :
  $\left( \sqrt{a} + \sqrt{b} \right)^2 = \left( \sqrt{a} \right)^2 + 2\sqrt{a}\sqrt{b} + \left( \sqrt{b} \right)^2 = a + b + 2\sqrt{ab}$
      ...
      \begin{array}{lll}
        \def\arraystretch{1.3} \begin{array}{rcl}
                                 A & = & \sqrt{72}                 \\
                                   ...
                                   & = & \sqrt{36} \times \sqrt{2} \\
                                   & = & 6\sqrt{2}                 \\
                               \end{array} & \def\arraystretch{1.3} \begin{array}{rcl}
                                                                      B & = & \sqrt{45}                \\
                                                                        & = & \sqrt{9 \times 5}        \\
                                                                        & = & \sqrt{9} \times \sqrt{5} \\
                                                                        & = & 3\sqrt{5}                \\
...
\begin{methode}[Réduire des expressions avec racines carrées]
  ...
  \[
    A = 4\sqrt{3} - 2\sqrt{3} + 6\sqrt{3} \qquad B
      = 7\sqrt{2} - 3\sqrt{5} + 8\sqrt{2} - \sqrt{5} \qquad C
      = \left( 3 - 2\sqrt{3} \right) - \left( 4 - 6\sqrt{3} \right)
  \]

  \textbf{2)} Écrire sous la forme $a\sqrt{b}$ ($b$ le plus petit possible) :
  \[
    D = \sqrt{12} + 7\sqrt{3} - \sqrt{27} \qquad E
      = \sqrt{125} - 2\sqrt{20} + 6\sqrt{80}
  \]
...
\begin{methode}[Développer et réduire avec des racines carrées]
  ...
  \[
    A
    = \left( \sqrt{3} - 4 \right)^2 \qquad B
    = \left( 3 + \sqrt{5} \right)^2 \qquad C
    = \left( \sqrt{2} - \sqrt{5} \right)\left( \sqrt{2} + \sqrt{5} \right) \qquad D
    = \left( 3 + \sqrt{3} \right)\left( 1 - \sqrt{2} \right)
  \]
