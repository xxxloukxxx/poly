...
\begin{definition}
	Une expérience (lancer une pièce par exemple) est \textbf{aléatoire} lorsqu'elle a plusieurs résultats ou issues (PILE ou FACE par exemple) et que l'on ne peut pas prévoir quel résultat se produira.

	L'ensemble de toutes les issues d'une expérience s'appelle \textbf{l'univers}.
\end{definition}
